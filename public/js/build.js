...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageHistory = __webpack_require__(4);
	...
	var Chat = function (_Component) {
	  ...
	  function Chat(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Chat).call(this, options));
	
	    _this._socket = null;
	    _this._username = null;
	
	    _this._messageForm = new MessageForm({
	      element: _this._el.querySelector('[data-component="message-form"]')
	    });
	
	    _this._messageHistory = new MessageHistory({
	      element: _this._el.querySelector('[data-component="message-history"]')
	    });
	
	    _this._loginForm = new LoginForm({
	      element: _this._el.querySelector('[data-component="login-form"]')
	    });
	
	    _this._messageForm.on('messageReady', _this._onInputFieldMessageReady.bind(_this));
	
	    _this._loginForm.on('login', _this._onLoginFormLogin.bind(_this));
	    return _this;
	  }
	
	  _createClass(Chat, [{
	    key: '_onInputFieldMessageReady',
	    value: function _onInputFieldMessageReady(event) {
	      var message = {
	        text: event.detail,
	    ...
	    key: '_onSocketBroadcast',
	    value: function _onSocketBroadcast(message) {
	      this._messageHistory.addMessage(message);
	    }
	  }, {
	    key: '_onLoginFormLogin',
	    value: function _onLoginFormLogin(event) {
	      this._socket = io();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MessageForm = function (_Component) {
	  ...
	  function MessageForm(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(MessageForm).call(this, options));
	
	    _this._input = _this._el.querySelector('[data-selector="message-input"]');
	
	    _this._el.addEventListener('submit', _this._onMessageSend.bind(_this));
	    return _this;
	  }
	
	  _createClass(MessageForm, [{
	    key: '_onMessageSend',
	    value: function _onMessageSend(event) {
	      event.preventDefault();
	
	      var message = this._input.value;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Component = __webpack_require__(2);
	var messageTemplateFunction = __webpack_require__(5);
	
	var MessageHistory = function (_Component) {
	  _inherits(MessageHistory, _Component);
	
	  function MessageHistory(options) {
	    _classCallCheck(this, MessageHistory);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MessageHistory).call(this, options));
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginForm = function (_Component) {
	  ...
	  function LoginForm(options) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LoginForm).call(this, options));
	
	    _this._error = _this._el.querySelector('[data-selector="error"]');
	    _this._password = _this._el.querySelector('[data-selector="password"]');
	    _this._name = _this._el.querySelector('[data-selector="name"]');
	
	    _this._el.addEventListener('submit', _this._onSubmit.bind(_this));
	    return _this;
	  }
	  ...
	  _createClass(LoginForm, [{
	    ...
	    key: '_onResponse',
	    value: function _onResponse(event) {
